...
public class PageLoadTimeout {
	...
	public static void main(String[] args) {
		...
		//driver.get("https://www.royalmansour.com/en");//pageloadtimeoutexception if the time limit to open page exceeds the page to overcome this we can write code as like in after webdriver line no 17 and 18 so we can restrict the time to load page
